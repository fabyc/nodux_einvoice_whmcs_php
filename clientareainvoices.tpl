        ...
        <tbody>
            {foreach key=num item=invoice from=$invoices}
                <tr onclick="clickableSafeRedirect(event, 'viewinvoice.php?id={$invoice.id}', false)">
                    ...
                    <td>
                    <a class="btn btn-info btn-sm" href="nodux/nodux.php?factura={$invoice.id}&tipo=factura" onClick="this.disabled=true">FACTURA</a>
	  	    <a class="btn btn-info btn-sm" href="nodux/nodux.php?factura={$invoice.id}&tipo=credito" onClick="this.disabled='disabled'">NOTA DE CREDITO</a>    
                    </td>   
                    <td><a class="btn btn-success" href="nodux/descargar.php?formato=pdf&id={$invoice.id}">RIDE</a></td>
